...
|-|-|-|-|-|-|-|-|-|-|
| 参照位置との差 | 4 | 3 | 2 | 1 | | | | | |
| 展開前 data(Hex) | 11 | 22 | 33 | 44 | - | - | - | - | - |
| 展開後 data(Hex) | 11 | 22 | 33 | 44 | 33 | 44 | 33 | 44 | 33 |

"参照位置との差"が2とはindex[3]を指す。ここから0x5バイト分のコピーを試みると、index[3]・index[4]の2バイトはコピー可能だが、残り3バイトは展開中バイト列の末尾を超えてしまう。

不足分はindex[3]・index[4]を繰り返してコピーする。結果としてindex[5]〜index[9]には `33 44 33 44 33` が書き込まれる。
